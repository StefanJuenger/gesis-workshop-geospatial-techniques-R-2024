...
With just two 'simple' command we can retrieve geospatial data about Cologne's Park & Ride parking spaces in `R`. Not too bad, right?
...
Not only vector data can be processed through these mechanisms.
...
The German Weather Service provides nice weather data in its Climata Data Center (CDC): https://opendata.dwd.de/climate_environment/CDC/
