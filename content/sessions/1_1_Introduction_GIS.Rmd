...
In the folder called `./data` in the same folder as the other materials for this workshop, you can find (most of) the data files prepped for all the exercises and slides. The following data are included:
...
Differentiating between different CRS is wild (at least for me...). In your research, you may hear from geographic, geocentric, projected, or local CRS.
...
- projection on flat surface (transformation of longitudes and latitudes to x and y coordinates)
