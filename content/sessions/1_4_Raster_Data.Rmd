...
In this course, we only use regular grid-based raster data. But be aware that also non-regular grid data exist.
...
## Relevant in this context: satellite data #WIP
