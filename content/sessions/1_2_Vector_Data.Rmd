...
- Polygons: enclosed area  (e.g, country, administrative borders)
]
...
Especially, point coordinates are often stored in table formats like `.csv` - as are the location of charging stations for electric cars in our `./data` folder. 
