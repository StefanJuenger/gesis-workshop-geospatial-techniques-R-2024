...
`sf::st_distance()` will calculate between **all** respondents and **all** train stations resulting in a matrix with 2,710,000 objects (1,000 respondent * 2,710 stations). We can make our lives a little bit easier by first identifying the nearest station and then calculate the distance.
